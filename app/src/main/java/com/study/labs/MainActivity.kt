...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_debug.setOnClickListener {
            startActivity(Intent(this, Lab31Activity::class.java))
        }
        ...
        button.setOnClickListener {
            val labActivity = when (spinner.selectedItem.toString()) {
                ...
                "15" -> Lab15Activity::class.java //Notes
                "16" -> Lab16Activity::class.java
                "17" -> Lab17Activity::class.java
                "18" -> Lab18Activity::class.java
                "19" -> Lab15Activity::class.java //Notes
                "20" -> Lab15Activity::class.java //Notes
                "21" -> Lab15Activity::class.java //Notes
                "22" -> Lab22Activity::class.java
                "23" -> Lab15Activity::class.java //Notes
                "24" -> Lab15Activity::class.java //Notes
                "25" -> Lab25Activity::class.java
                "26" -> Lab25Activity::class.java
                "27" -> Lab15Activity::class.java //Notes
                "28" -> Lab28Activity::class.java
                "29" -> Lab29Activity::class.java
                "30" -> Lab15Activity::class.java //Notes
                "31" -> Lab31Activity::class.java
                //"32" -> Lab32Activity::class.java
                //"33" -> Lab15Activity::class.java //Notes
                //"34" -> Lab15Activity::class.java //Notes
                else -> null
            }
